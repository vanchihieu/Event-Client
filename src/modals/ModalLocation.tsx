...
console.log(process.env.MAP_API_KEY4);
...
const ModalLocation = (props: Props) => {
  ...
  console.log('🚀 ~ ModalLocation ~ currentLocation:', currentLocation);
  ...
  const handleSearchLocation = async () => {
    const api = `https://autocomplete.search.hereapi.com/v1/autocomplete?q=${searchKey}&limit=20&apiKey=zCDIlA5ytRuEe3YS9YrJlzAGjTkxsy4S6mJtq7ZpkGU`;

    try {
      setIsLoading(true);
      const res = await axios.get(api);
      console.log('🚀 ~ handleSearchLocation ~ res:', res);
  ...
  console.log('🚀 ~ ModalLocation ~ addressSelected:', addressSelected);
